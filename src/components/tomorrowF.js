...
export const TomorrowF = () => {
    ...
    return <div className='lg:w-[60%] w-[80%] mt-[3.5rem] mx-auto'>
        <h1 className='border-b-2 lg:text-2xl pb-2'>Forecast for tomorrow</h1>
        <section>
            <Card 
                src={weather.forecast.forecastday[1].hour[10].condition.icon} 
                condition={weather.forecast.forecastday[1].hour[10].condition.text} 
                time={'10:00'} 
                deg={fahrenheit ? `${weather.forecast.forecastday[1].hour[10].temp_f}` : `${weather.forecast.forecastday[1].hour[10].temp_c}`} 
                realFeel={fahrenheit ? `${weather.forecast.forecastday[1].hour[10].feelslike_f}` : `${weather.forecast.forecastday[1].hour[10].feelslike_c}`} 
            ...
            <Card 
                ...
                time={'12:00'} 
                deg={fahrenheit ? `${weather.forecast.forecastday[1].hour[12].temp_f}` : `${weather.forecast.forecastday[1].hour[12].temp_c}`} 
                realFeel={fahrenheit ? `${weather.forecast.forecastday[1].hour[12].feelslike_f}` : `${weather.forecast.forecastday[1].hour[12].feelslike_c}`} 
            ...
            <Card 
                ...
                time={'14:00'} 
                deg={fahrenheit ? `${weather.forecast.forecastday[1].hour[14].temp_f}` : `${weather.forecast.forecastday[1].hour[14].temp_c}`} 
                realFeel={fahrenheit ? `${weather.forecast.forecastday[1].hour[14].feelslike_f}` : `${weather.forecast.forecastday[1].hour[14].feelslike_c}`} 
            ...
            <Card 
                ...
                time={'16:00'} 
                deg={fahrenheit ? `${weather.forecast.forecastday[1].hour[16].temp_f}` : `${weather.forecast.forecastday[1].hour[16].temp_c}`} 
                realFeel={fahrenheit ? `${weather.forecast.forecastday[1].hour[16].feelslike_f}` : `${weather.forecast.forecastday[1].hour[16].feelslike_c}`} 
            ...
            <Card 
                ...
                time={'18:00'} 
                deg={fahrenheit ? `${weather.forecast.forecastday[1].hour[18].temp_f}` : `${weather.forecast.forecastday[1].hour[18].temp_c}`} 
                realFeel={fahrenheit ? `${weather.forecast.forecastday[1].hour[18].feelslike_f}` : `${weather.forecast.forecastday[1].hour[18].feelslike_c}`} 
