    ...
    return <div className='w-[60%] mt-[5rem] mx-auto'>
        ...
        <section>
            ...
            <Card 
                ...
                time={`${hour + 1}:00`} 
                deg={weather.forecast.forecastday[0].hour[hour + 1].temp_c} 
                cor={weather.forecast.forecastday[0].hour[hour + 1].chance_of_rain} 
                realFeel={weather.forecast.forecastday[0].hour[hour + 1].feelslike_c} 
            ...
            <Card 
                ...
                time={`${hour + 2}:00`} 
                deg={weather.forecast.forecastday[0].hour[hour + 2].temp_c} 
                cor={weather.forecast.forecastday[0].hour[hour + 2].chance_of_rain} 
                realFeel={weather.forecast.forecastday[0].hour[hour + 2].feelslike_c} 
            ...
            <Card 
                ...
                time={`${hour + 3}:00`} 
                deg={weather.forecast.forecastday[0].hour[hour + 3].temp_c} 
                cor={weather.forecast.forecastday[0].hour[hour + 3].chance_of_rain} 
                realFeel={weather.forecast.forecastday[0].hour[hour + 3].feelslike_c} 
            ...
            <Card 
                ...
                time={`${hour + 4}:00`} 
                deg={weather.forecast.forecastday[0].hour[hour + 4].temp_c} 
                cor={weather.forecast.forecastday[0].hour[hour + 4].chance_of_rain} 
                realFeel={weather.forecast.forecastday[0].hour[hour + 4].feelslike_c} 
            ...
            <Card 
                ...
                time={`${hour + 5}:00`} 
                deg={weather.forecast.forecastday[0].hour[hour + 5].temp_c} 
                cor={weather.forecast.forecastday[0].hour[hour + 5].chance_of_rain} 
                realFeel={weather.forecast.forecastday[0].hour[hour + 5].feelslike_c} 
    ...
    return <div className='w-[60%] mt-[5rem] mx-auto'>
        ...
        <section>
            ...
            <Card 
                ...
                time={`${hour + 6}:00`} 
                deg={weather.forecast.forecastday[0].hour[hour + 6].temp_c} 
                cor={weather.forecast.forecastday[0].hour[hour + 6].chance_of_rain} 
                realFeel={weather.forecast.forecastday[0].hour[hour + 6].feelslike_c} 
            ...
            <Card 
                ...
                time={`${hour + 8}:00`} 
                deg={weather.forecast.forecastday[0].hour[hour + 8].temp_c} 
                cor={weather.forecast.forecastday[0].hour[hour + 8].chance_of_rain} 
                realFeel={weather.forecast.forecastday[0].hour[hour + 8].feelslike_c} 
            ...
            <Card 
                ...
                time={`${hour + 10}:00`} 
                deg={weather.forecast.forecastday[0].hour[hour + 10].temp_c} 
                cor={weather.forecast.forecastday[0].hour[hour + 10].chance_of_rain} 
                realFeel={weather.forecast.forecastday[0].hour[hour + 10].feelslike_c} 
