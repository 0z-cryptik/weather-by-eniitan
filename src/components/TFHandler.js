    ...
    return <div className='lg:w-[60%] md:w-[80%] w-[90%] mt-[2.5rem] md:mt-[5rem] mx-auto'>
        ...
        <section>
            ...
            <Card 
                ...
                time={`${hour + 1}:00`} 
                deg={fahrenheit ? `${weather.forecast.forecastday[0].hour[hour + 1].temp_f}` : `${weather.forecast.forecastday[0].hour[hour + 1].temp_c}`} 
                cor={weather.forecast.forecastday[0].hour[hour + 1].chance_of_rain} 
                realFeel={fahrenheit ? `${weather.forecast.forecastday[0].hour[hour + 1].feelslike_f}` : `${weather.forecast.forecastday[0].hour[hour + 1].feelslike_c}`}
            ...
            <Card 
                ...
                time={`${hour + 2}:00`} 
                deg={fahrenheit ? `${weather.forecast.forecastday[0].hour[hour + 2].temp_f}` : `${weather.forecast.forecastday[0].hour[hour + 2].temp_c}`} 
                cor={weather.forecast.forecastday[0].hour[hour + 2].chance_of_rain} 
                realFeel={fahrenheit ? `${weather.forecast.forecastday[0].hour[hour + 2].feelslike_f}` : `${weather.forecast.forecastday[0].hour[hour + 2].feelslike_c}`} 
            ...
            <Card 
                ...
                time={`${hour + 3}:00`} 
                deg={fahrenheit ? `${weather.forecast.forecastday[0].hour[hour + 3].temp_f}` : `${weather.forecast.forecastday[0].hour[hour + 3].temp_c}`} 
                cor={weather.forecast.forecastday[0].hour[hour + 3].chance_of_rain} 
                realFeel={fahrenheit ? `${weather.forecast.forecastday[0].hour[hour + 3].feelslike_f}` : `${weather.forecast.forecastday[0].hour[hour + 3].feelslike_c}`} 
            ...
            <Card 
                ...
                time={`${hour + 4}:00`} 
                deg={fahrenheit ? `${weather.forecast.forecastday[0].hour[hour + 4].temp_f}` : `${weather.forecast.forecastday[0].hour[hour + 4].temp_c}`} 
                cor={weather.forecast.forecastday[0].hour[hour + 4].chance_of_rain} 
                realFeel={fahrenheit ? `${weather.forecast.forecastday[0].hour[hour + 4].feelslike_f}` : `${weather.forecast.forecastday[0].hour[hour + 4].feelslike_c}`} 
            ...
            <Card 
                ...
                time={`${hour + 5}:00`} 
                deg={fahrenheit ? `${weather.forecast.forecastday[0].hour[hour + 5].temp_f}` : `${weather.forecast.forecastday[0].hour[hour + 5].temp_c}`} 
                cor={weather.forecast.forecastday[0].hour[hour + 5].chance_of_rain} 
                realFeel={fahrenheit ? `${weather.forecast.forecastday[0].hour[hour + 5].feelslike_f}` : `${weather.forecast.forecastday[0].hour[hour + 5].feelslike_c}`} 
...
export const F1Forecast = () => {
    ...
    return <div className='lg:w-[60%] md:w-[80%] w-[90%] mt-[2.5rem] md:mt-[5rem] mx-auto'>
        <h1 className='border-b-2 md:text-2xl pb-2'>Forecast for the next 1 hour</h1>
        <section>
    ...
    return <div className='lg:w-[60%] md:w-[80%] w-[90%] mt-[2.5rem] md:mt-[5rem] mx-auto'>
        ...
        <section>
            ...
            <Card 
                ...
                time={`${hour + 6}:00`} 
                deg={fahrenheit ? `${weather.forecast.forecastday[0].hour[hour + 6].temp_f}` : `${weather.forecast.forecastday[0].hour[hour + 6].temp_c}`} 
                cor={weather.forecast.forecastday[0].hour[hour + 6].chance_of_rain} 
                realFeel={fahrenheit ? `${weather.forecast.forecastday[0].hour[hour + 6].feelslike_f}` : `${weather.forecast.forecastday[0].hour[hour + 6].feelslike_c}`} 
            ...
            <Card 
                ...
                time={`${hour + 8}:00`} 
                deg={fahrenheit ? `${weather.forecast.forecastday[0].hour[hour + 8].temp_f}` : `${weather.forecast.forecastday[0].hour[hour + 8].temp_c}`} 
                cor={weather.forecast.forecastday[0].hour[hour + 8].chance_of_rain} 
                realFeel={fahrenheit ? `${weather.forecast.forecastday[0].hour[hour + 8].feelslike_f}` : `${weather.forecast.forecastday[0].hour[hour + 8].feelslike_c}`} 
            ...
            <Card 
                ...
                time={`${hour + 10}:00`} 
                deg={fahrenheit ? `${weather.forecast.forecastday[0].hour[hour + 10].temp_f}` : `${weather.forecast.forecastday[0].hour[hour + 10].temp_c}`} 
                cor={weather.forecast.forecastday[0].hour[hour + 10].chance_of_rain} 
                realFeel={fahrenheit ? `${weather.forecast.forecastday[0].hour[hour + 10].feelslike_f}` : `${weather.forecast.forecastday[0].hour[hour + 10].feelslike_c}`} 
